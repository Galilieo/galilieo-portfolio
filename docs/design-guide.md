...
- 归档页通过原生 Tabs 在博客笔记与个人轨迹之间切换，两套内容都使用语义化 `<ol>`、中央主轴和左右交替卡片；移动端统一降为左轴。个人轨迹当前确认时间为软件工程学习 `2024.09 — 至今`、Heart Island 持续开发 `2026.04 — 至今`、AI 产品开发实习 `2026.06 — 至今`，并链接到真实项目与 `/campus/`。About 不再复制时间线，只展示真实头像、身份、介绍、事实和入口。
